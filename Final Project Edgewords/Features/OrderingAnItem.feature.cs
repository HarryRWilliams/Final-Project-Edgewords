...
namespace Final_Project_Edgewords.Features
{
    ...
    [NUnit.Framework.DescriptionAttribute("OrderingAnItem")]
    public partial class OrderingAnItemFeature
    {
...
#line hidden
        ...
        public virtual void FeatureSetup()
        {
            ...
            TechTalk.SpecFlow.FeatureInfo featureInfo = new TechTalk.SpecFlow.FeatureInfo(new System.Globalization.CultureInfo("en-US"), "Features", "OrderingAnItem", "This feature checks that an item can be ordered and that the order number is reta" +
                    "ined", ProgrammingLanguage.CSharp, featureTags);
